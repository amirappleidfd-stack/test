...
const AccordionInbound: FC<AccordionInboundType> = ({
  ...
  const { inbounds, defaultInbound } = useDashboard();
                  ...
                  <Accordion w="full" allowToggle>
                    <AccordionItem border="0">
                      <div style={{ display: "flex", alignItems: "center" }}>
                        ...
                        {!defaultInbound && index < hosts.length - 1 && (
...
export const HostsDialog: FC = () => {
  const { isEditingHosts, onEditingHosts, refetchUsers, inbounds, defaultInbound, defaultInboundTag } =
    useDashboard();
              ...
              {defaultInbound && (
                ...
                >
                  <Text fontSize="sm" color="green.700" _dark={{ color: "green.200" }}>
                    {t("hostsDialog.defaultInboundLocked", {
                      tag: defaultInboundTag || "DEFAULT",
                    }) ||
                      `Inbound "${defaultInboundTag || "DEFAULT"}" is managed automatically (Active) and cannot be edited or deleted.`}
                  </Text>
                </Box>
              )}
