...
from app.default_inbound import ensure_default_inbound, is_default_inbound_enabled
...
def start_core():
    ...
    # Enforce the single permanent Default Inbound (rewrites xray_config.json +
    # restores Reality keys from the DB) before the core starts.
    if is_default_inbound_enabled():
        ensure_default_inbound()
